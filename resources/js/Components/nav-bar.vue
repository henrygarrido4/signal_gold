        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box horizontal-logo">
            <Link href="/" class="logo logo-dark">
              <span class="logo-sm">
                <img src="@assets/images/logo-trax-sm.png" alt="" height="22" />
              </span>
              <span class="logo-lg">
                <img src="@assets/images/logo-signal-auth.png" alt="" height="17" />
              </span>
            </Link>
        ...
        <div class="d-flex align-items-center">
          ...
          <BDropdown class="dropdown" variant="ghost-secondary" dropstart
            ...
            <div class="p-2">
              <BRow class="g-0">
                <BCol>
                  <BLink class="dropdown-icon-item" href="https://auth.iterable.com/u/login/identifier?state=hKFo2SBIM3ZTdlp6SDRLZjMyNThrakQzZ1MtdGFaSkVPYTdLUaFur3VuaXZlcnNhbC1sb2dpbqN0aWTZIEFMemRsenhpY0Y2UC1rcXBBTXNxdlN3Yy1mVUNNSTVKo2NpZNkgR0VuR2x6WHFyaXlndTV2VTZZYlZxMk0wMTBzQkdsdVI" target="_blank">
                    <img src="@assets/images/brands/iterable.png" alt="iterable" />
                    <span>Iterable</span>
                  </BLink>
                </BCol>
                <BCol>
                  <BLink class="dropdown-icon-item" href="https://us-west-2b.online.tableau.com/#/site/cars/views/EmailDashboards/EmailDashboard?:iid=1" target="_blank">
                    <img src="@assets/images/brands/tableau.png" alt="tableau" />
                    <span>Tableau</span>
                  </BLink>
                </BCol>
                <BCol>
                  <BLink class="dropdown-icon-item" href="https://everest.validity.com/dashboards/" target="_blank">
                    <img src="@assets/images/brands/validity.png" alt="validity" />
                    <span>Validity</span>
                  </BLink>
                </BCol>
              </BRow>
          ...
          <BDropdown variant="link" class="ms-sm-3 header-item topbar-user" toggle-class="rounded-circle arrow-none" menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -14, crossAxis: 0, mainAxis: 0 }">
            ...
            <Link class="dropdown-item" href="/apps-todo">
