    ...
    <div>
      ...
      <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
          <!-- Dark Logo-->
          <Link href="/dashboard/analytics" class="logo logo-dark">
            <span class="logo-sm">
              <img src="@assets/images/logo-trax-sm.png" alt="" height="25" />
            </span>
            <span class="logo-lg">
              <img src="@assets/images/logo-signal.png" alt="" height="50" />
            </span>
          </Link>
          <!-- Light Logo-->
          <Link href="/dashboard/analytics" class="logo logo-light">
            <span class="logo-sm">
              <img src="@assets/images/logo-trax-sm.png" alt="" height="25" />
            </span>
            <span class="logo-lg">
