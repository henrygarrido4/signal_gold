                    ...
                    <BCol lg="12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                ...
                                <img src="@assets/images/logo-signal.png" alt="" height="70">
                                </Link>
                            </div>
                            <p class="mt-3 fs-15 fw-medium text-white ">Real-Time Email Insights & Performance</p>
                        </div>
                    </BCol>
                </BRow>
                        ...
                        <BCard no-body class="mt-4">
                            ...
                            <BCardBody class="p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your free Signal Dashboard account now</p>
                                </div>
                                <div class="p-2 mt-4">
                ...
                <BRow>
                    <BCol lg="12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; {{ new Date().getFullYear() }} Signal Dashboard. Crafted with <i class="mdi mdi-heart text-danger"></i> by Henrry Garrido</p>
                        </div>
                    </BCol>
                </BRow>
            </BContainer>
